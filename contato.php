...
<head>
	...
	<title>Impacta Jovem | Contato</title>
	<meta name="description" content="Impacta Jovem Brasil">
	<meta name="keywords" content="Impacta Jovem Brasil">
	<meta name="title" content="Impacta Jovem Brasil">
	<link rel="shortcut icon" type="image/png" href="https://impactajovembrasil.com/Imagens/Impacta/logo.png"/>
	<meta property="og:title" content="Impacta Jovem Brasil">
    <meta property="og:description" content="Contato">
    <meta property="og:image" content="https://impactajovembrasil.com/Imagens/Impacta/logo.jpg">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Impacta Jovem Brasil">
    <meta property="og:url" content="https://impactajovembrasil.com/contato">
...
<body>
	...
	<nav id="navmobile" class="fixed-top">
			...
			<div class="logo">
				<a href="https://impactajovembrasil.com">
					<img src="Imagens/Impacta/logo.png" style="left:20px; width: 45px; height: auto; padding-right: 10px;">
					<span style="color: #055673; font-size: 18px">IMPACTAJOVEM</span><span style="color: #daaa1b; font-size: 14px">BRASIL</span>
				</a>
			</div>

			<div class="menuBtn" data-toggle="collapse" data-target="#whitenavbar">
			...
			<div class="collapse navbar-collapse" id="whitenavbar">
					<ul class="navbar-nav vertical-center">
						<!--mr,ml,mx auto -->
						<li class="nav-item">
							<a href="./sobre" class="nav-link ">SOBRE</a>
						</li>
	...
	<div class="container">
		<p>Você pode entrar em contato conosco para enviar o seu feedback ou dúvida sobre os nossos projetos, processos de aplicações, organização, patrocínios, parcerias e sobre o que você gostaria de ver no nosso website.</p>
<!--action https://instagram.us18.list-manage.com/subscribe/post?u=7d91057dd19acfda4ec4833ad&amp;id=005189af86-->
...
<?php
        ...
        if (!empty($dados['contato'])) {
            ...
            if (!$empty_input) {
                $query_usuario = "INSERT INTO usuarios (nome, email, mensagem) VALUES (:nome, :email, :mensagem) ";
                $contactar = $conn->prepare($query_usuario);
                $contactar->bindParam(':nome', $dados['nome'], PDO::PARAM_STR);
                $contactar->bindParam(':email', $dados['email'], PDO::PARAM_STR);
                $contactar->bindParam(':email', $dados['mensagem'], PDO::PARAM_STR);
                $contactar->execute();
                if ($contactar->rowCount()) {
                    echo "<p style='color: green;'>Recebemos seu contato!</p>";
                    unset($dados);
                } else {
                    echo "<p style='color: #f00;'>Erro: não conseguimos receber seu contato</p>";
                }
            }
        }
        ?>
		...
		<label style="color: white;" for="email-address"> nome </label>
			<input type="text" name="nome" id="nome-contato" value="<?php
            if (isset($dados['nome'])) {
                echo $dados['nome'];
            }
            ?>">
			<label style="color: white;" for="email-address"> email </label>
			<input type="email" id="email-contato" name="email" required maxlength="64" minlength="7" value="<?php
            if (isset($dados['email'])) {
                echo $dados['email'];
            }
            ?>"> 
			<textarea name="mensagem" id="mensagem" cols="30" rows="10" value="<?php
            if (isset($dados['mensagem'])) {
                echo $dados['mensagem'];
            }
            ?>"> sua mensagem </textarea>
						
			<fieldset><input type="submit" value="contato" name="contato"></fieldset>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md text-center">
							...
							<a href="./newsletter"><button class="btn news"
...
<script>
    (function() {
		...
		var inputNumber = document.querySelector('#form-contato #inputNumber');
		var pContact = document.querySelector('#form-contato p');
